...
import { selectUserInfo, updateUserInfo, updateUserPassword } from '../../features/Users/userSlice';
import { Icon } from '@mdi/react';
import { mdiAccount } from '@mdi/js';
import { ChangePasswordModal } from '../../shared/ui/ChangePasswordModal/ChangePasswordModal';
        ...
        <form className={style.profilePage__user} onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className={style.profilePage__userBio}>
              <div>
                ...
                <button type='button' className={style.profilePage__button} onClick={() => setIsPasswordModalOpen(true)}>
                  Изменить пароль
                </button>
              </div>
